...
export default function FloatingContact() {
  ...
  return (
    <>
      {/* Floating Contact Container - Middle Right (slightly down) */}
      <div className="fixed right-0 top-1/2 -translate-y-1/3 z-50 flex flex-col items-end">
        {/* Contact Buttons */}
        <div
          className={`
        ...
        {/* Main Toggle Button - Now at the bottom */}
        <button
