              ...
              {steps.map((step: any, index: number) => (
                ...
                >
                  ...
                  <div className="relative mb-6">
                    <div
                      className={`w-20 h-20 mx-auto rounded-full flex items-center justify-center border-2 transition-all duration-300 backdrop-blur-sm ${
                        activeStep === index
                    ...
                    >
                      <div
                        className={`w-16 h-16 rounded-full flex items-center justify-center transition-all duration-300 backdrop-blur-sm ${
                          activeStep === index
                    ...
                    {/* Step Number Badge */}
                    <div
                      className={`absolute -top-2 -right-2 w-10 h-10 rounded-full flex items-center justify-center font-bold text-sm transition-all duration-300 backdrop-blur-sm border ${
                        activeStep === index
                  ...
                  {/* Step Content */}
                  <div
                    className={`text-center p-6 rounded-xl border transition-all duration-300 backdrop-blur-sm ${
                      activeStep === index
                  ...
                  {index < steps.length - 1 && (
                    <div className="absolute top-10 right-0 transform translate-x-1/2">
                      <ArrowRight
                        className={`w-6 h-6 transition-all duration-300 backdrop-blur-sm ${
                          activeStep === index
