...
export const vehicleTypes: VehicleType[] = [
  {
    ...
    description: 'Zero-emission electric vehicles with advanced battery technology',
    icon: '⚡',
    features: ['Zero emissions', 'Low operating costs', 'Instant torque', 'Advanced technology']
  },
  {
    id: 'phev',
    name: 'PHEV',
    ...
    icon: '🔌',
    features: ['Electric + Gasoline', 'Longer range', 'Flexible charging', 'Reduced emissions']
  },
  {
    id: 'reev',
    name: 'REEV',
    ...
    icon: '🔄',
    features: ['Electric primary', 'Range extender', 'No range anxiety', 'Efficient']
  },
  {
    id: 'petrol',
    name: 'Petrol',
    ...
    icon: '⛽',
    features: ['Proven technology', 'Wide availability', 'Quick refueling', 'Lower upfront cost']
  }
];
...
export const services: Service[] = [
  {
    ...
    description: 'Access to extensive network of manufacturers and dealers across China',
    icon: '🔍'
  },
  {
    title: 'Quality Inspection',
    description: 'Comprehensive pre-shipment inspection ensuring vehicle quality',
    icon: '✅'
  },
  {
