const arTranslations = {
  ...
  vehicles: {
    ...
    mobileInstructions:
      "انقر على أي بطاقة مركبة لعرض المواصفات والمميزات التفصيلية",
  ...
  contact: {
    ...
    subtitle:
      "دعم احترافي على مدار الساعة لاستفسارات المركبات والأسعار وفرص الشراكة",
  ...
  about: {
    ...
    description:
      "شريكك الموثوق لتصدير السيارات الصينية مع أكثر من عقد من الخبرة",
    storyTitle: "قصتنا",
    fullDescription:
    ...
    features: {
      experience: {
        title: "الخبرة",
        description:
          "أكثر من 10 سنوات من الخبرة في تصدير السيارات، وفهم احتياجات السوق في مختلف المناطق.",
      },
      quality: {
        title: "ضمان الجودة",
        description:
          "فحص دقيق للمركبات وعمليات مراقبة الجودة لضمان وصول أفضل السيارات فقط لعملائنا.",
      },
      global: {
        title: "الوصول العالمي",
        description:
          "شبكة لوجستية راسخة وشراكات لشحن سلس إلى الوجهات في جميع أنحاء العالم.",
      },
      support: {
        title: "دعم العملاء",
        description:
          "فريق دعم متعدد اللغات على مدار الساعة مكرس لمساعدة العملاء طوال العملية.",
      },
    },
    ctaTitle: "مستعدون للشراكة معنا؟",
    ctaDescription:
      "انضم إلى مئات الشركاء الراضين في جميع أنحاء العالم الذين يثقون بشركة دا تشين أوتو لاحتياجاتهم من السيارات.",
  ...
  filters: {
    ...
    sortOptions: {
      ...
      yearNew: "الأحدث أولاً",
      yearOld: "الأقدم أولاً",
      nameA: "الاسم: من أ إلى ي",
      nameZ: "الاسم: من ي إلى أ",
    },
  },
  models: {
    // New keys for ModelsUI
    heroTitle: "سيارات عالية الجودة",
    heroSubtitle: "استكشف سيارات فاخرة لقيادة استثنائية",
    searchPlaceholder: "البحث حسب الماركة، النموذج، الفئة، الميزات...",
    searchHint: "البحث عبر الماركات، النماذج، الفئات، والميزات",
    clearSearch: "مسح البحث",
    vehicleBrandsTitle: "ماركات السيارات ({count})",
    allBrands: "جميع السيارات",
    allBrandsShort: "كل الماركات",
    brandTitle: "{brand} ({count} موديل)",
    searchResultsTitle: "نتائج البحث ({count})",
    allModelsTitle: "جميع موديلات السيارات ({count})",
    brandModelsTitle: "{brand} ({count} موديل)",
    searchPaginationInfo:
      "الصفحة {current} من {total} • عرض {showing} سيارة مطابقة",
    paginationInfo:
      "الصفحة {current} من {total} • عرض {showing} من {totalItems} سيارة",
    show: "عرض",
    previousPage: "الصفحة السابقة",
    nextPage: "الصفحة التالية",
    showingPagination: "عرض {start} إلى {end} من {total} سيارة",
    noSearchResultsTitle: "لم يتم العثور على نتائج بحث",
    noVehiclesFound: "لم يتم العثور على سيارات",
    noSearchResultsDescription:
      'لم يتم العثور على سيارات لـ "{query}". جرب كلمات رئيسية مختلفة.',
    noVehiclesAvailable: "لا توجد سيارات متاحة في الوقت الحالي.",
    noBrandVehicles: "لا توجد سيارات {brand} متاحة.",
    viewAllBrands: "عرض جميع الماركات",
    brandsAvailableTitle: "الماركات المتاحة ({count})",
    brandError:
      'لم يتم العثور على سيارات للماركة "{brand}". عرض جميع السيارات بدلاً من ذلك.',
    noSearchResults: 'لم يتم العثور على نتائج لـ "{query}"',
    searchResultsFound:
      '{count} نتيجة{count !== "1" ? "ات" : ""} وجدت لـ "{query}"',
    showingResults: "عرض {current} من {total} سيارة مطابقة",
    whatsappMessage:
      "مرحباً! أنا مهتم بسيارة {brand} {model} ({year}).\n\nالسعر: {price}\n\nهل يمكنك تقديم المزيد من التفاصيل؟",
    specs: {
      engine: "المحرك",
      power: "القدرة",
      seats: "المقاعد",
  ...
  process: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: "تسليم من الباب إلى الباب",
      },
    ],
  },
  // Footer
