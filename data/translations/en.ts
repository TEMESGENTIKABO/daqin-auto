const enTranslations = {
  ...
  hero: {
    ...
    description: "Xi'an Da Qin Dao Rui International Trade Co., Ltd provides high-quality gasoline, electric, and hybrid vehicles from globally leading brands.",
    stats: {
      brands: "Brands",
  ...
  process: {
    ...
    subtitle: "A transparent, step-by-step approach ensuring quality and timely delivery",
  ...
  vehicles: {
    title: "Vehicle Types",
    subtitle: "Comprehensive range of vehicle technologies for diverse market needs",
    portfolio: "Portfolio",
    keySpecifications: "Key Specifications",
    mainFeatures: "Main Features",
    mobileInstructions: "Tap on any vehicle card to view detailed specifications and features",
    ...
    ev: {
      ...
      description: "Fully electric vehicles with zero emissions and advanced technology",
      features: [
    ...
    phev: {
      ...
      description: "Combines electric motor with petrol engine for maximum flexibility",
      features: [
    ...
    reev: {
      ...
      description: "Electric drive with onboard generator for extended range capabilities",
      features: [
...
// About
  about: {
    ...
    description: "Your trusted partner for Chinese automotive exports with over a decade of experience",
    storyTitle: "Our Story",
    fullDescription: "Da Qin Auto, under Xi'an Da Qin Dao Rui International Trade Co., Ltd., is an independent automobile supplier and exporter based in China.",
    mission: {
      title: "Our Mission",
    ...
    features: {
      experience: {
        title: "Experience",
        description: "Over 10 years of expertise in automotive exports, understanding market needs across different regions."
      },
      quality: {
        title: "Quality Assurance",
        description: "Rigorous vehicle inspection and quality control processes to ensure only the best vehicles reach our clients."
      },
      global: {
        title: "Global Reach",
        description: "Established logistics network and partnerships for seamless shipping to destinations worldwide."
      },
      support: {
        title: "Customer Support",
        description: "24/7 multilingual support team dedicated to assisting clients throughout the entire process."
      }
    },
    ctaTitle: "Ready to Partner With Us?",
    ctaDescription: "Join hundreds of satisfied partners worldwide who trust Da Qin Auto for their automotive needs.",
 ...
 // Contact details
  ...
  contact: {
    ...
    subtitle: "24/7 professional support for vehicle inquiries, pricing, and partnership opportunities",
